...
void compress_dir(const std::filesystem::path, std::string = "");

void decompress_file(std::ifstream&, std::filesystem::path, std::string);
void decompress_file(const std::filesystem::path, std::string = "");
void decompress_dir(std::ifstream&, std::string);
void decompress_dir(const std::filesystem::path, std::string = "");